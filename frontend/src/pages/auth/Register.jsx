...
import { registerUser } from "../../utills/api.js";
        ...
        >
          ...
          <div className="text-center space-y-1 md:space-y-2">
            <div className="flex items-center justify-center gap-1 md:gap-3">
              ...
              <h1 className="text-2xl md:text-4xl font-extrabold text-emerald-300 tracking-tight">
                Contacts
              </h1>
            </div>
          ...
          <div className="flex justify-center items-center gap-2 text-sm">
            <p className=" text-xs md:text-sm text-gray-400">Already have an account?</p>
            <NavLink
              to="../login"
              className="text-emerald-300 font-mono md:font-semibold hover:underline text-sm md:text-md"
            >
              Sign in
            </NavLink>
          </div>
